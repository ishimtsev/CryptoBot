namespace CryptoBot
{
	partial class OrderBook
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Количество пунктов:";
			// 
			// textBox1
			// 
			...
			// OKbutton
			// 
			this.OKbutton.Location = new System.Drawing.Point(92, 349);
			...
			this.textBox2.Size = new System.Drawing.Size(376, 438);
			...
			this.Name = "OrderBook";
			this.Text = "Стакан для валютной пары";
